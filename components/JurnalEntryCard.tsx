    ...
    <article className="bg-white rounded-[24px] border border-[#e8e2d9] overflow-hidden hover:shadow-md transition-shadow">
      <div className="p-6 flex items-center justify-between border-b border-[#f5f0e8]">
        ...
        <div className="flex gap-2 ml-3">
          {editing ? (
            <>
              <button onClick={() => { setEditing(false); setDay(entry.day); setTitle(entry.title); setDeskripsi(entry.deskripsi); setFoto(null) }} className="text-xs px-4 py-2 rounded-full border border-[#e8e2d9] text-[#6b5e4e] hover:bg-[#f9f7f2]">Batal</button>
